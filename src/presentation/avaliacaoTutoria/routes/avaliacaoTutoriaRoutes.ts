...
// POST /api/avaliacao-tutoria - Criar avaliação (tutores e alunos)
router.post('/', authMiddleware, authorizeRoles(['tutor', 'student']), (req, res) => 
  avaliacaoTutoriaController.create(req, res)
);

// GET /api/avaliacao-tutoria/minhas - Usuário listar suas próprias avaliações
router.get('/minhas', authMiddleware, authorizeRoles(['tutor', 'student']), (req, res) => 
...
router.put('/:id', authMiddleware, authorizeRoles(['tutor', 'student']), (req, res) => 
